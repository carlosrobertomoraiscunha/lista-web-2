...
<html>
    ...
    <body>
        <div class="container-fluid">
            <div class="alert alert-warning alert-dismissible fade show" role="alert" id="alertFormat" style="display: none">
                ...
                <form method="POST" class="w-100" id="formCpfCnpj">
                    <div class="form-row justify-content-center">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="valueInput" name="valueInput" pattern="[0-9]+$" placeholder="Digite seu cpf/cnpj" required>
                        </div>
        ...
        <script src="scripts/format_cpf_cnpj.js"></script>
    </body>
</html>
